...
from src.models.modeling import VisionTransformer, CONFIGS
from src.utils.data_utils import get_loader
from src.utils.dist_util import get_world_size
from src.utils.scheduler import WarmupLinearSchedule, WarmupCosineSchedule
...
def setup(args):
    ...
    num_classes = 2 if args.dataset == "hymenoptera" else num_classes
    ...
    while True:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                optimizer.zero_grad()
                global_step += 1
                scheduler.step()  # Change according to latest pytorch docs
